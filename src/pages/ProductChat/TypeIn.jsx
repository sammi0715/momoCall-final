...
function TypeIn() {
  return (
    <div className="bg-primary-600 py-2 px-3 flex gap-2 fixed bottom-0 w-full">
      ...
      <input type="text" placeholder="輸入訊息" className="bg-bg-white grow rounded-3xl pl-3 focus:outline-primary" />
      <button className="bg-white w-8 h-8 rounded-full active:border-primary active:border">
