...
function OrderCard() {
  ...
  return (
    <div className={`${state.showOrderInfo ? "grid" : "hidden"}  fixed mt-0 bg-black-0 w-container py-2 px-3 grid-cols-4 gap-6 top-[68px] mt-[68px] left-0 right-0 z-10 my-0 mx-auto`}>
