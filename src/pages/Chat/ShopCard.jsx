...
function ShopCard() {
  ...
  return (
    <div className={`w-full product bg-white fixed z-10 ${renderState.showShopInfo && !renderState.showOrderInfo ? "flex" : "hidden"} justify-center gap-6 py-2 mt-[68px] items-center`}>
