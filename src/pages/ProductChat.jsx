...
function ProductChat() {
  return (
    <div className=" font-sans w-container mx-auto ">
      ...
      <div className="mt-[160px] mb-12 bg-black-200 h-full py-4 px-3 flex flex-col gap-4">
        <p className="flex items-center justify-center bg-accent rounded-large text-center text-sm leading-normal py-1 ">
